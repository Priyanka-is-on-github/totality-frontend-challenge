...
const services = [
  {
    ...
    description: "Build responsive, fast, and secure websites using modern web technologies.",
    image: "src/assets/service_images/webdev.jpg", 
  },
  {
    title: "Mobile Development",
    description: "Develop high-performance mobile apps with an excellent user experience.",
